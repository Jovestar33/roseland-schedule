...
---
*Last updated: 2026-05-25 — Phase 8 Snapshot UX Polish complete and tested. Snapshot storage model, creation paths, UI surfaces, cap increase (10 → 25), and Save As New propagation guard documented in Section 9. Tools Panel Restore tab quirk updated to reflect Phase 8 card layout. Feature Map updated. UX and storage-cap update — no new versioning architecture or storage schema changes.*

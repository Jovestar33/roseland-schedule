...
**Schedule editing**: action rows, custom rows, sun rows, notes, call time, location (short display name plus collapsible full address; optional stacked sub-locations with the same name/address pattern, Google Places autocomplete, map pin, status checkbox, description), town, date, weather strip

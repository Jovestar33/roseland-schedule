...
---
*Last updated: 2026-05-25 — Phase 6 Library Declutter / Mobile Polish complete and tested. Library row action model documented (desktop vs mobile, active vs archived). Templates tab save-from-library input removed. Town · Date metadata line removed from rows. Mobile search placeholder fix. UI-only pass — no data model or storage changes.*

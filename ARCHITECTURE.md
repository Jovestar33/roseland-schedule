...
---
*Last updated: 2026-05-26 — Phase 9 Schedule Header Identity Fields complete and tested. Schedule header identity block behavior, ComboInput show-all-on-open, and strict Day slash-notation validation documented in Section 9. Feature Map updated. No ScheduleMeta shape changes, no storage schema changes, no server-side function changes.*

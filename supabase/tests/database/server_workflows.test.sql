...
truncate private.schedule_transfers, private.schedule_copy_receipts, public.schedule_restrictions, public.schedule_versions, public.schedules, public.production_days, public.phases;

// Bounded B09-A browser fixture launcher. No token-race or provider investigation.
...
ensureFixture();
function ensureFixture(){const f=JSON.parse(readFileSync('/private/tmp/roseland-b09-fixtures.json','utf8'));if(f.project!==project)throw Error('B09 fictional fixture required');}
...
try{
 ...
 console.log('READY: fictional B09-A workspace. No provider-race tests run.');

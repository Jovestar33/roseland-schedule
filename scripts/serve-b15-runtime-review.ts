...
const port=3514,project='roseland-b14-destination-g2';
...
const api=process.argv.includes('--faults')?'http://127.0.0.1:3513':config.API_URL;
...
writeFileSync('/private/tmp/roseland-b15-runtime-process.json',JSON.stringify({launcher:process.pid,server:app.pid,port,project,api,build:readFileSync('.next/BUILD_ID','utf8').trim()}),{mode:0o600});

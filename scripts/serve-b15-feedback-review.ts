...
const port=3520,project='roseland-b14-destination-g2';
...
writeFileSync('/private/tmp/roseland-b15-feedback-process.json',JSON.stringify({launcher:process.pid,server:app.pid,port,project,api,build:readFileSync('.next/BUILD_ID','utf8').trim()}),{mode:0o600});

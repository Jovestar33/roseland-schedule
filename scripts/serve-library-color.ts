...
const port=3530,project='roseland-b14-destination-g2';
...
writeFileSync('/private/tmp/roseland-library-color-process.json',JSON.stringify({launcher:process.pid,server:app.pid,port,project,api,build:readFileSync('.next/BUILD_ID','utf8').trim()}),{mode:0o600});

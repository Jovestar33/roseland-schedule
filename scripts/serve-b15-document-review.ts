...
const port=3516,project='roseland-b14-destination-g2';
...
const api=process.argv.includes('--faults')?'http://127.0.0.1:3515':config.API_URL;
...
writeFileSync('/private/tmp/roseland-b15-document-process.json',JSON.stringify({launcher:process.pid,server:app.pid,port,project,api,build:readFileSync('.next/BUILD_ID','utf8').trim()}),{mode:0o600});

// Bounded B10-B organization lifecycle browser fixture launcher. No token-race or provider investigation.
...
ensureFixture();
function ensureFixture(){const f=JSON.parse(readFileSync('/private/tmp/roseland-b10b-fixtures.json','utf8'));if(f.project!==project)throw Error('B10-B fictional fixture required');}
...
try{
 ...
 console.log('READY: fictional B10-B workspace. No provider-race tests run.');
